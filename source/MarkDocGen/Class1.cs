...
namespace DefaultDocumentation
{
   ...
   {
      public static SmartEnumerable<T> AsSmart<T>(this IEnumerable<T> sequence)
      {
         return sequence is SmartEnumerable<T> smartEnumerable ? smartEnumerable : new SmartEnumerable<T>(sequence);
      }
   }
}
